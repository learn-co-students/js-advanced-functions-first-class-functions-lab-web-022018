...
function createFareMultiplier(int_x){
  return function(fare){ return fare * int_x}
}
...
//   and triples it.
function selectDifferentDrivers(array,some_function){
  return some_function(array)
}
